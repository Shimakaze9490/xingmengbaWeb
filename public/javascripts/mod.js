...
!function (e) {
    if (!require) {
        var r = document.getElementsByTagName("head")[0],
            ...
            s = function (e, t) {
                for (var n = document.createDocumentFragment(), i = 0, u = e.length; u > i; i++) {
                    ...
                    if (!(s in a)) {
                        ...
                        }(c, o), c.type = "text/javascript", c.src = s, n.appendChild(c)
                    }
                }
                r.appendChild(n)
            },
            c = function (e, r, n) {
                for (var i = [], a = 0, c = e.length; c > a; a++) {
                    ...
                    var f, d = u[l] || u[l + ".js"] || {},
                        h = d.pkg;
                    f = h ? o[h].url || o[h].uri : d.url || d.uri || l, i.push({
                        id: l,
                        url: f
                    })
                }
        ...
        define = function (e, r) {
            e = e.replace(/\.js$/i, ""), n[e] = r;
            var i = t[e];
            if (i) {
                for (var a = 0, u = i.length; u > a; a++) i[a]();
                delete t[e]
            }
        }, require = function (e) {
            ...
            return a && (r.exports = a), r.exports
            ...
            if (!(e in a)) {
                ...
                t.type = "text/javascript", t.src = e, r.appendChild(t)
            }
